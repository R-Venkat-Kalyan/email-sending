...
public class AppController {
	...
	public String sendPlainTextEmail(Model model) {
		String from = "2100030959rvk@gmail.com";
	...
	public String sendHTMLEmail(Model model) throws MessagingException {
		String from = "kalyanreddy1439@gmail.com";
		String to = "2100030959cseh@gmail.com";
	...
	public String sendHTMLEmailWithAttachment(Model model) throws MessagingException {
		...
		FileSystemResource file = new FileSystemResource(new File("C:\\Users\\DELL\\Downloads\\Skill Workbook.pdf"));
		helper.addAttachment("Skill Workbook.pdf", file);
